...
namespace MusicfyAPI.Controllers
{
    ...
    public class AlbumesController : ControllerBase
    {
        ...
        public AlbumesController(MusicfyDbContext context)
        {
            _context = context;
        }
        ...
        {
            int cantidad = _context.Albumes.Count();

            if (cantidad >= 20)
            {
                return Problem("Ya existen 20 albumes. No se pueden registrar más.", statusCode: 500);
            }
